...
def test_df2bedrmod():
    ...
    data = [
        ...
        ['2', 1001, 1002, 'm5C', 850, '-', 1001, 1002, '0,255,0', 45, 83],
        ['chrX', 3001, 3002, 'm1A', 700, '+', 3001, 3002, '0,0,255', 6, 79],
        ['chrY', 4001, 4002, 'm3C', 920, '-', 4001, 4002, '255,255,0', 50, 37],
        ['chrM', 5001, 5002, 'm3C', 920, '-', 5001, 5002, '255,255,0', 23, 65]
    ]
